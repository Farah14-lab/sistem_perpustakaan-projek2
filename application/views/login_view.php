...
<div class="login-box">
  ...
  <div class="login-logo">
    <a href="index.php" style="color: Blue;"><b>SISTEM INFORMASI<br/><b>PERPUSTAKAAN</b></a>
  </div>
  ...
  <footer>
    <div class="login-box-body text-center bg-blue">
       <a style="color: White;"> Copyright &copy; Sistem Informasi Perpustakaan SMAN 01 Batu <?php echo date("Y");?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
